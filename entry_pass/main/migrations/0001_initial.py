# Generated by Django 4.1.2 on 2022-10-31 07:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('duration_type', models.CharField(choices=[('annual', 'Годовой'), ('one-time', 'Разовый')], max_length=10, null=True, verbose_name='Тип')),
                ...
                ('can_be_extended', models.DateField(blank=True, null=True, verbose_name='Можно продлить')),
                ...
                ('car', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='passes', to='main.car', verbose_name='Транспортное средство')),
            ],
            options={
